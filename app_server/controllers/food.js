...
module.exports.homelist = function(req, res){
  ...
  module.exports.create_food = function(req, res){
  ...
  module.exports.load_Edited_Data = function(req, res){
  ...
  module.exports.create_food_items = function(req, res){
    var requestOptions, path;
    path = '/api/food';
  ...
  module.exports.put_Item = function(req, res){
